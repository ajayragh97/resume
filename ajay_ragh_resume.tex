...
%-----------SUMMARY-----------------
\section{Summary}
Graduate in electronics and communication engineering with experience in analyzing,inferring and optimizing of governmental models,prototyping,testing and validating of algorithms in swarm robotics,analyzing and proposing applications in transparent electronics
\begin{itemize}
  \item Knowledge about engineering concepts and a proven ability to ideate and prototype applications in IoT,statistical analysis and swarm algorithms. 
  \item Ability to adapt rapidly to new environments and fields of study, such as mathematical modeling,data analysis and its applications across fields such as swarm algorithms and governmental models.
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Technology in Electronics and Communication;  GPA: 7.02}{July. 2015 -- June. 2019}
    \resumeSubheading
